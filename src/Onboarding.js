...
const QUESTIONS = [
    {
        ...
        answers: [
            { label: "Chill & relax",     emoji: "🛋️", desc: "Quiet, comfortable, no stress",          weights: { noise: 2.5, temperature: 1.5, humidity: 1.0, wind: 0.5, airQuality: 0.5, rain: 0.5 } },
            { label: "Active & outdoors", emoji: "🏃", desc: "Fresh air, some breeze, get moving",     weights: { airQuality: 2.0, wind: 1.5, temperature: 1.5, noise: 0.5, humidity: 0.5, rain: 1.0 } },
            { label: "Work & focus",      emoji: "💻", desc: "Minimal distractions, stable conditions", weights: { noise: 3.0, rain: 1.5, humidity: 0.5, temperature: 0.5, airQuality: 0.5, wind: 0.0 } },
            { label: "Social hangout",    emoji: "👥", desc: "Good vibes for a group",                 weights: { temperature: 2.0, noise: 1.0, rain: 1.5, airQuality: 1.0, humidity: 0.5, wind: 0.5 } }
        ]
    },
    {
        ...
        answers: [
            { label: "Love the sun",          emoji: "☀️", desc: "The hotter the better",     weights: { temperature: 0.5, humidity: 1.5, wind: 0.5, noise: 0.5, airQuality: 0.5, rain: 1.0 } },
            { label: "Somewhere in between",  emoji: "😌", desc: "Not too hot, not too cold", weights: { temperature: 1.5, humidity: 1.0, wind: 1.0, noise: 0.5, airQuality: 0.5, rain: 0.5 } },
            { label: "Easily overheated",     emoji: "🥵", desc: "Shadow and breeze please",  weights: { temperature: 2.5, wind: 1.5, humidity: 1.5, noise: 0.0, airQuality: 0.5, rain: 0.0 } },
            { label: "Always freezing",       emoji: "🥶", desc: "More warmth, less wind",    weights: { temperature: 2.5, wind: 0.0, humidity: 0.5, noise: 0.5, airQuality: 0.5, rain: 1.0 } }
        ]
    },
    {
        ...
        answers: [
            { label: "Too loud",           emoji: "🔊", desc: "Noise ruins everything for me",      weights: { noise: 3.5, airQuality: 0.5, temperature: 0.5, humidity: 0.5, wind: 0.0, rain: 0.5 } },
            { label: "Bad air quality",    emoji: "😷", desc: "Pollution and dust are a no-go",    weights: { airQuality: 3.5, noise: 0.5, temperature: 0.5, humidity: 0.5, wind: 0.5, rain: 0.0 } },
            { label: "Rain or wind",       emoji: "🌧️", desc: "I hate getting wet or blown around", weights: { rain: 2.5, wind: 1.5, temperature: 0.5, noise: 0.5, airQuality: 0.5, humidity: 0.0 } },
            { label: "Uncomfortable temp", emoji: "🌡️", desc: "Temperature makes or breaks it",    weights: { temperature: 3.0, humidity: 1.5, wind: 0.5, noise: 0.5, airQuality: 0.0, rain: 0.0 } }
        ]
    }
];
...
const METRIC_LABELS = { noise: "Quiet spots", airQuality: "Fresh air", temperature: "Temperature", humidity: "Humidity", wind: "Wind comfort", rain: "Dry conditions" };
const METRIC_EMOJIS = { noise: "🔇", airQuality: "🌿", temperature: "🌡️", humidity: "💧", wind: "🍃", rain: "☀️" };
...
function readScoresFromDOM(resultStack) {
    const scores = {};
    const keyMap = { "Noise": "noise", "Air quality": "airQuality", "Temperature": "temperature", "Humidity": "humidity", "Wind": "wind", "Rain": "rain" };
    resultStack.querySelectorAll(".score-list li").forEach(li => {
